...
public class UsuarioDAO {
    ...
    public Usuario buscarUsuarioPorId(int id) {
        ...
        try {
            ...
            throw new RuntimeException("Erro ao buscar usuarios por ID: " + e.getMessage(), e);
        } finally {
            closeResources(conn, stmt, rs);
        }
    }
    ...
    public Usuario buscarUsuarioPorEmail(String email) {
        ...
        try {
            ...
            throw new RuntimeException("Erro ao buscar usuarios por email: " + e.getMessage(), e);
        } finally {
            closeResources(conn, stmt, rs);
        }
    }
    ...
    public void atualizarUsuario(Usuario usuario) {
        String sql = "UPDATE usuarios SET nome = ?, email = ?, senha = ?, tipo_usuario = ?, fisioterapeuta_id = ?, ativo = ? WHERE id = ?";
        ...
        try {
            ...
            if (linhasAfetadas == 0) {
                throw new RuntimeException("Nenhum usuário encontrado com ID: " + usuario.getId());
            }

        } catch (SQLException e) {
            throw new RuntimeException("Erro ao atualizar usuarios: " + e.getMessage(), e);
        } finally {
            closeResources(conn, stmt, null);
        }
    }
    ...
    public void deletarUsuario(int id) {
        ...
        try {
            ...
            throw new RuntimeException("Erro ao deletar usuarios: " + e.getMessage(), e);
        } finally {
            closeResources(conn, stmt, null);
        }
    }
    ...
    private Usuario mapearResultSetParaUsuario(ResultSet rs) throws SQLException {
        ...
        usuario.setTipoUsuario(
                Usuario.TipoUsuario.valueOf(
                        rs.getString("tipo_usuario").toUpperCase()
                )
        );
